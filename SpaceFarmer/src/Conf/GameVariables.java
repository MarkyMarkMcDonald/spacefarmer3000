...
public class GameVariables {
    ...
    public static final int maxDistance = (int) Math.sqrt(Math.pow(quadrantXDimension * universeColumns,2) + Math.pow(quadrantYDimension * universeRows,2));
	...
	public static final double randomEventChancce=.05;
